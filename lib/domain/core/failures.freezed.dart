...
class _$ValueFailureCopyWithImpl<T, $Res, $Val extends ValueFailure<T>>
  ...
  @override
  $Res call({
    Object? faildValue = null,
  }) {
    return _then(_value.copyWith(
      faildValue: null == faildValue
          ? _value.faildValue
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.faildValue, faildValue) ||
                other.faildValue == faildValue));
  }

  @override
  int get hashCode => Object.hash(runtimeType, faildValue);
...
abstract class InvalidEmail<T> implements ValueFailure<T> {
  const factory InvalidEmail({required final String faildValue}) =
      _$InvalidEmail<T>;
...
abstract class ShortPassword<T> implements ValueFailure<T> {
  const factory ShortPassword({required final String faildValue}) =
      _$ShortPassword<T>;
